...
class ExistentialEdge(
    ...
    /**
     * One ExistentialEdge, exactly one new variable, used in arity assigner by computing min and max arity
     */
    override fun getNumberOfAdditionalTerms(): Int = 1
    ...
    override fun copy(): Edge {
        return ExistentialEdge(from, to, isCyclic, termOrder, termOrderShuffleAllowed = termOrderShuffleAllowed, termOrderReference = termOrderReference)
    }
    ...
    override fun toString(): String {
        return "ExistentialEdge(from=$from, to=$to, isCyclic=$isCyclic, termOrder=$termOrder, uniqueId='$uniqueId')"
    }
