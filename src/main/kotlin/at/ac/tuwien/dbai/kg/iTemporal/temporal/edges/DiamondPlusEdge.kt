...
class DiamondPlusEdge(override var from: Node,
    ...
    override fun copy(): Edge {
        return DiamondPlusEdge(from=from, to=to, isCyclic=isCyclic, termOrder=termOrder, t1=t1, t2=t2, termOrderShuffleAllowed = termOrderShuffleAllowed, termOrderReference = termOrderReference)
    }

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is DiamondPlusEdge) return false
    ...
    override fun toString(): String {
        return "DiamondPlusEdge(from=$from, to=$to, isCyclic=$isCyclic, termOrder=$termOrder, t1=$t1, t2=$t2, uniqueId='$uniqueId')"
    }
