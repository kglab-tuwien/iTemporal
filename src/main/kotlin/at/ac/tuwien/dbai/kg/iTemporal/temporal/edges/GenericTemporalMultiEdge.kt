...
class GenericTemporalMultiEdge(override var from: Node,
                               ...
                               override var isLeftEdge: Boolean = false,
    ...
    override fun getLabel(): String {
        return "GenericTemporalMultiEdge"
    }

    override fun copy(): Edge {
        return GenericTemporalMultiEdge(from=from, to=to, isCyclic=isCyclic, termOrder=termOrder, t1=t1, t2=t2, isLeftEdge=isLeftEdge, termOrderShuffleAllowed = termOrderShuffleAllowed, termOrderReference = termOrderReference)
    }

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is GenericTemporalMultiEdge) return false
