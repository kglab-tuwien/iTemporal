...
class BoxPlusEdge(override var from: Node,
    ...
    override fun copy(): Edge {
        return BoxPlusEdge(from=from, to=to, isCyclic=isCyclic, termOrder=termOrder, t1=t1, t2=t2, termOrderShuffleAllowed = termOrderShuffleAllowed, termOrderReference = termOrderReference)
    }

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is BoxPlusEdge) return false
    ...
    override fun toString(): String {
        return "BoxPlusEdge(from=$from, to=$to, isCyclic=$isCyclic, termOrder=$termOrder, t1=$t1, t2=$t2, uniqueId='$uniqueId')"
    }
