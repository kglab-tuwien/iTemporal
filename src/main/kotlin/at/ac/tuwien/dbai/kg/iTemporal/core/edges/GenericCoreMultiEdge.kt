...
class GenericCoreMultiEdge(override var from: Node,
    ...
    override fun getLabel(): String {
        return "GenericCoreMultiEdge"
    }

    override fun copy(): Edge {
        return GenericCoreMultiEdge(from, to, isCyclic, termOrder, termOrderShuffleAllowed = termOrderShuffleAllowed, termOrderReference = termOrderReference)
    }

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is GenericCoreMultiEdge) return false
