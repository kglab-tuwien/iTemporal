...
/**
 * Converts a given GenericAggregationEdge to a STAEdge.
 */
object STARuleAssignment : RuleAssignment {
    override fun getPriority(): Int = 51

    override fun getNumberOfExistingEdges(dependencyGraph: DependencyGraph): Int {
        return dependencyGraph.inEdges.values.flatten().filterIsInstance<STAEdge>().count()
    }

    override fun getTypeStatisticProperty(): Double {
        return Registry.properties.spanningTemporalAggregationRules
    }
