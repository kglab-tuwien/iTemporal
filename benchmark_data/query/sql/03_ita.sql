...
COPY start_date (i0, i1, i2, i3, i4) FROM '/data/03_ita/start_date_10.csv' DELIMITER ',' CSV HEADER;
...
WITH a as (SELECT DISTINCT i0,i1,i2, generate_series(i3, i4, '1 seconds') as timeunit
FROM start_date),
