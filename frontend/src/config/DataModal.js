...
import {genData, genRules} from "../store/graphSlice";
...
export default function DataModal({open, setOpen}) {

    const cancelButtonRef = useRef(null)
    const generatedData = useSelector(genData)

    const tabs = Object.keys(generatedData)
                            ...
                            <div className="flex items-start">
                                <div className="mt-3 mt-0 text-left w-full">
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <pre className="overflow-x-scroll mt-5 text-sm text-gray-500">{generatedData[tabs[currentTab]]}</pre>
                                    </div>
                                </div>
                            </div>
                        </div>
